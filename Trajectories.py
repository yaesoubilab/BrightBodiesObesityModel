...
#         df_trajectories.set_obj(x_value=[age, s],
#                                 obj=traj)
...
# # FEMALES
# # Female 13
# f_13_rows = InOutSupport.read_csv_rows('csv_trajectories/female_13_obese.csv',
#                                        delimiter=',',
#                                        if_del_first_row=True,
#                                        if_convert_float=True)
...
#
# # Female 14
# f_14_rows = InOutSupport.read_csv_rows('csv_trajectories/female_14_obese.csv',
#                                        delimiter=',',
#                                        if_del_first_row=True,
#                                        if_convert_float=True)
# # Female 15
# f_15_rows = InOutSupport.read_csv_rows('csv_trajectories/female_15_obese.csv',
#                                        delimiter=',',
#                                        if_del_first_row=True,
#                                        if_convert_float=True)
# # Female 16
# f_16_rows = InOutSupport.read_csv_rows('csv_trajectories/female_16_obese.csv',
#                                        delimiter=',',
#                                        if_del_first_row=True,
#                                        if_convert_float=True)
# # MALES
# # Male 13
# m_13_rows = InOutSupport.read_csv_rows('csv_trajectories/male_13_obese.csv',
#                                        delimiter=',',
#                                        if_del_first_row=True,
#                                        if_convert_float=True)
# # Male 14
# m_14_rows = InOutSupport.read_csv_rows('csv_trajectories/male_14_obese.csv',
#                                        delimiter=',',
#                                        if_del_first_row=True,
#                                        if_convert_float=True)
# # Male 15
# m_15_rows = InOutSupport.read_csv_rows('csv_trajectories/male_15_obese.csv',
#                                        delimiter=',',
#                                        if_del_first_row=True,
#                                        if_convert_float=True)
# # Male 16
# m_16_rows = InOutSupport.read_csv_rows('csv_trajectories/male_16_obese.csv',
#                                        delimiter=',',
#                                        if_del_first_row=True,
#                                        if_convert_float=True)
#
# # YOUNGER - using older data for now to run model without errors
# f_8_rows = InOutSupport.read_csv_rows('csv_trajectories/female_13_obese.csv', delimiter=',', if_del_first_row=True, if_convert_float=True)
# f_9_rows = InOutSupport.read_csv_rows('csv_trajectories/female_13_obese.csv', delimiter=',', if_del_first_row=True, if_convert_float=True)
# f_10_rows = InOutSupport.read_csv_rows('csv_trajectories/female_13_obese.csv', delimiter=',', if_del_first_row=True, if_convert_float=True)
# f_11_rows = InOutSupport.read_csv_rows('csv_trajectories/female_13_obese.csv', delimiter=',', if_del_first_row=True, if_convert_float=True)
# f_12_rows = InOutSupport.read_csv_rows('csv_trajectories/female_13_obese.csv', delimiter=',', if_del_first_row=True, if_convert_float=True)
# m_8_rows = InOutSupport.read_csv_rows('csv_trajectories/male_13_obese.csv', delimiter=',', if_del_first_row=True, if_convert_float=True)
# m_9_rows = InOutSupport.read_csv_rows('csv_trajectories/male_13_obese.csv', delimiter=',', if_del_first_row=True, if_convert_float=True)
# m_10_rows = InOutSupport.read_csv_rows('csv_trajectories/male_13_obese.csv', delimiter=',', if_del_first_row=True, if_convert_float=True)
# m_11_rows = InOutSupport.read_csv_rows('csv_trajectories/male_13_obese.csv', delimiter=',', if_del_first_row=True, if_convert_float=True)
# m_12_rows = InOutSupport.read_csv_rows('csv_trajectories/male_13_obese.csv', delimiter=',', if_del_first_row=True, if_convert_float=True)
#
#
#
# # ROWS
